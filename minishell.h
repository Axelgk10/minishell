#ifndef MINISHELL_H
# define MINISHELL_H
# define _POSIX_C_SOURCE 200809L //Y esto?
...
char			*get_env_values(char **env, const char *var_name);
int				is_valid_var_name(char *name);
int				find_variable_index(char **env_var, char \
*var_name, int name_len);
...
char			*create_var_with_value(char *var_assignment, \
char *equals_pos, char **var_name, int *name_len);

void			update_env_array(char **env_var, \
char *new_var, char *var_name, int name_len);
